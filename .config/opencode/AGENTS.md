...
- **Abstractions**: consciously constrained, pragmatically parametrised, documented when non-obvious
...
- When doing research or factual synthesis, cite only sources retrieved in the current workflow
- Never fabricate citations, URLs, IDs, quotes, or publication details
- Attach citations or attribution to the specific claims they support, not only at the end
- If sources conflict, state the conflict explicitly and attribute each side
- Label inferences as inferences rather than presenting them as directly supported facts
- If the available evidence is insufficient, narrow the claim or say you cannot support it
